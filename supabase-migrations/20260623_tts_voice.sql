...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS tts_gender TEXT DEFAULT 'wanita';
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS tts_speed  REAL DEFAULT 1.0;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS tts_voice  TEXT DEFAULT 'sari';
